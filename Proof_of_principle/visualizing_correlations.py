...
if __name__ == '__main__':
    ...
    var_strs = json.loads(config['Visualize_correlation']['vars']) 
    vars = []
    ...
    preprocess_data = json.loads(config['Visualize_correlation']['preprocess_data']) 
    extractions = int(config['Visualize_correlation']['extractions'])
    ...
    filename = '/Correlation_{}'.format(var_strs)
    filename += ".pdf"
