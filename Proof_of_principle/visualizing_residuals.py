...
if __name__ == '__main__':
    ...
    g2=statistical_tool.visualize_correlation(x, y, xlabel=xlabel, ylabel=ylabel, ranges=ranges, model_points=model_points)
    ...
    # plot_ranges = json.loads(config['Figure_settings']['plot_ranges'])
